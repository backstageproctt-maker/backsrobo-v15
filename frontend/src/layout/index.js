...
const useStyles = makeStyles((theme) => ({
  ...
  drawerPaper: {
    ...
    whiteSpace: "nowrap",
    width: drawerWidth,
    background: "radial-gradient(circle, #0056b3 0%, #002d5f 100%)", // Degradê Azul Profissional
    color: "#FFFFFF",
  ...
  drawerPaperClose: {
    overflowX: "hidden",
    overflowY: "hidden",
    background: "radial-gradient(circle, #0056b3 0%, #002d5f 100%)",
    transition: theme.transitions.create("width", {
      easing: theme.transitions.easing.sharp,
      duration: theme.transitions.duration.leavingScreen,
    }),
  ...
  content: { 
    ...
    overflow: "visible", 
    position: "relative",
    backgroundColor: "#F8FAFC" // Fundo das páginas levemente cinza/azul
  },
  ...
  containerWithScroll: {
    ...
    "& .MuiListItemIcon-root": {
        color: "#94A3B8", // Ícones levemente cinzas por padrão
    },
    "& .MuiListItem-root:hover": {
        backgroundColor: "rgba(255, 255, 255, 0.05)",
        "& .MuiListItemIcon-root": {
            color: "#FFFFFF", // Ícones brancos no hover
        },
    },
    "& .MuiListItem-root.Mui-selected": {
        backgroundColor: "rgba(255, 255, 255, 0.1)",
        "& .MuiListItemIcon-root": {
            color: "#FFFFFF", // Ícone branco se selecionado
        },
        "&:hover": {
        ...
        <Toolbar variant="dense" className={classes.toolbar}>
          ...
          <div className={classes.topbarScroller}>
            ...
            <IconButton edge="start" onClick={colorMode.toggleColorMode}>
              {theme.mode === "dark" ? (
                <Brightness7Icon style={{ color: "#F59E0B" }} />
              ) : (
                <Brightness4Icon style={{ color: "#1E293B" }} />
              )}
            </IconButton>
